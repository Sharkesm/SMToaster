...
s.description      = 'Toasting view similar to Android toasting message feature and includes seperate card toast views.'

  s.homepage         = 'https://github.com/Sharkesm/SMToaster'
